...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-center my-4" style={{borderBottom:"5px solid #ff5165", paddingBottom: "10px", width:"15%", margin: "auto", borderBottomLeftRadius: "5px", borderBottomRightRadius: "5px"}}>Our Features</h2>
